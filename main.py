...
PROFESSIONS_LECTURES = {
    ...
    "teacher": {
        "name": "Педагог",
        "lectures": {
            "psychology": "Детская психология",
            "methods": "Методики обучения",
            "special": "Специальная педагогика",
            "digital": "Цифровая педагогика"
        }
    },
    "engineer": {
        "name": "Инженер",
    ...
    "manager": {
        ...
        "lectures": {
            ...
            "strategic": "Стратегическое управление"
        }
    },
    "journalist": {
        "name": "Журналист",
        "lectures": {
            "writing": "Мастерство письма",
            "investigation": "Журналистское расследование",
            "multimedia": "Мультимедийная журналистика",
    ...
    "gamedev": {
        ...
        "lectures": {
            ...
            "graphics": "Графика для игр",
            "monetization": "Монетизация и продвижение игр"
        }
    }
}
